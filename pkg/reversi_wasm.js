...
*/
export function str_to_computer_strength(s) {
    const ptr0 = passStringToWasm0(s, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.str_to_computer_strength(ptr0, len0);
    return ret;
}
...
export class Game {
    ...
    */
    constructor(is_human, computer_strength) {
    ...
    */
    put(x, y) {
        const ret = wasm.game_put(this.__wbg_ptr, x, y);
        return ret;
    }
    /**
    * Get the board
    ...
    */
    can_put_stone(x, y) {
        const ret = wasm.game_can_put_stone(this.__wbg_ptr, x, y);
        return ret !== 0;
    }
    /**
    * @returns {(Point)[]}
    */
    get_can_put_stones() {
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.game_get_can_put_stones(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
